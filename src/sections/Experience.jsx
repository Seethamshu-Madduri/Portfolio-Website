...
const Experience = () => {
    return (
        <section id="experience" className="py-20 bg-black transition-colors">
                ...
                <div className="max-w-3xl mx-auto">
                    {resumeData.experience.map((exp, index) => (
                        <div key={index} className="relative pl-8 md:pl-0">
                            ...
                            >
                                {/* Timeline Dot */}
                                <div className="absolute left-0 md:left-1/2 w-4 h-4 rounded-full bg-primary border-4 border-gray-900 transform md:-translate-x-1/2 mt-1.5 md:mt-0"></div>
